...
# 21. Quais são os aluno que participam do volêI e do futebol?
...
b.nome_aluno
FROM tb_volei AS a
CROSS JOIN tb_futebol AS b;
    
# 22. Entre os alunos que participam do basquete qual não participa do volei?

select nome_aluno from tb_basquete 
where nome_aluno not in (select nome_aluno from tb_volei);
