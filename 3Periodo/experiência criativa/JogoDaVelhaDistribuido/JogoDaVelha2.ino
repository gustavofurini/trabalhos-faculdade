...
byte colPins[COLS] = {3,2,A1,A2}; //connect to the column pinouts of the keypad
...
void envia_mensagem(){
  ...
  Serial.println(countRodadas);
  if (countRodadas >= 5) {
    Serial.println("Velha");
    while (1 == 1) {
      AcenderLed(0, true, 255, 0, 0);
      AcenderLed(1, true, 255, 0, 0);
      AcenderLed(2, true, 255, 0, 0);
      AcenderLed(3, true, 255, 0, 0);
      AcenderLed(4, true, 255, 0, 0);
      AcenderLed(5, true, 255, 0, 0);
      AcenderLed(6, true, 255, 0, 0);
      AcenderLed(7, true, 255, 0, 0);
      AcenderLed(8, true, 255, 0, 0);
      AcenderLed(9, true, 255, 0, 0);
      AcenderLed(10, true, 255, 0, 0);
      AcenderLed(11, true, 255, 0, 0);
      delay(500);
