# -*- coding: utf-8 -*-
"""TrabalhoCacheOk.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1BNBkwrMWHPkf3Erix9eyZCSeVDefQGO6
"""
...
class Cache(Memoria):
    ...
    def read(self, address):
        ...
        r = (address // self.cache_line_size) % self.cache_lines  # CALCULA O ÍNDICE DA LINHA NA CACHE
        ...
        if self.cache[r] is not None and self.cache[r]['tag'] == t:
            # PEGA O VALOR DA CACHE
            result = self.cache[r]['data'][address % self.cache_line_size]
    ...
    def write(self, address, val):
        ...
        if self.cache[r] is not None and self.cache[r]['tag'] == t:
            # ATUALIZA A CACHE
            self.cache[r]['data'][address % self.cache_line_size] = val
            # TAMBÉM ATUALIZA NA RAM
    ...
    def update_cache(self, r, t):
        ...
        # LÊ OS DADOS DA RAM E ATUALIZA A CACHE COM OS NOVOS DADOS DA RAM
